  ...
  return (
    <div className="appinfo-container">
      ...
      <form onSubmit={handleSubmit} className="appinfo-form">
        ...
        <input style={{ gridArea: "rnumber" }} type="text" name="App_Rnumber" onChange={e => handleInputChange(e)} />
        ...
        <select onChange={e => handleOpenPermit(e)} style={{ gridArea: "open" }} name="App_permit_Open">
          {rendergrouplist()}
        </select>

        <label style={{ gridArea: "todolist-title" }}>To Do List State Permissions</label>
        <select onChange={e => handleTodolistPermit(e)} style={{ gridArea: "todolist" }} name="App_permit_toDoList">
          {rendergrouplist()}
        </select>

        <label style={{ gridArea: "doing-title" }}>Doing State Permissions</label>
        <select onChange={e => handleDoingPermit(e)} style={{ gridArea: "doing" }} name="App_permit_Doing">
          {rendergrouplist()}
        </select>

        <label style={{ gridArea: "done-title" }}>Done State Permissions</label>
        <select onChange={e => handleDonePermit(e)} style={{ gridArea: "done" }} name="App_permit_Done">
          {rendergrouplist()}
        </select>
