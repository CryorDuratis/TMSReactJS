...
const TaskList = props => {
  ...
  return (
    <div className="content-container bgclr-light1">
      {isModalOpen && (ModalMode === "create" ? <CreateTask onClose={handleCloseModal} update={updateTaskList} appid={appid} /> : <EditTask onClose={handleCloseModal} update={updateTaskList} appacro={ModalMode} />)}
