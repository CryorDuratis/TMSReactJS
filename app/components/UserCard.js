  ...
  return (
    <Container listkey={props.listkey} class={props.class}>
      <form className="user-form">
        ...
        <input type="password" name="password" value={password} placeholder="********" disabled={props.editing !== editkey && !props.create} onChange={e => handlePasswordChange(e)} className={error ? "form-password error-outline" : "form-password"} />
